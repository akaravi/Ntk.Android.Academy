...
public class DetailPoolingActivity extends AppCompatActivity {
                ...
                .subscribe(new Observer<PoolingContentListResponse>() {
                    ...
                    public void onNext(PoolingContentListResponse poolingContentListResponse) {
                        if (poolingContentListResponse.IsSuccess) {
                            DetailPoolCategoryAdapter adapter = new DetailPoolCategoryAdapter(DetailPoolingActivity.this, poolingContentListResponse.ListItems);
                    ...
                    public void onError(Throwable e) {
                        Toasty.warning(DetailPoolingActivity.this, "خطای سامانه", Toasty.LENGTH_LONG, true).show();
