...
public class ArticleDetailActivity extends BaseArticleDetail2_2_Activity {
    @Override
    ...
    protected RecyclerView.Adapter createOtherInfoAdapter(List<ArticleContentOtherInfoModel> info) {
        return new TabArticleAdapter(ArticleDetailActivity.this, info);

    }

    @Override
    protected RecyclerView.Adapter createSimilarContentAdapter(List<ArticleContentModel> listItems) {
        return new ArticleAdapter(ArticleDetailActivity.this, listItems);
    }
